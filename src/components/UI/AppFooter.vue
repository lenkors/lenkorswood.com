<template>
  ...
  <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    ...
    <div class="text-gray-400 text-sm text-center py-8">© 2019 - {{ presentYear }}. {{ t('I18N_0006') }}</div>
  </footer>
</div>
</template>
...
presentYear.value = date.getFullYear(); 
